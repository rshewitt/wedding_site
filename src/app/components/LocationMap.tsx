...
const MAP_TITLE = "The Mazant, New Orleans";
        ...
        <div id="location_div" className="flex flex-col-reverse md:flex-row">
            <div className="w-full px-4 md:w-1/2">
                <div className="bg-white rounded-lg shadow-lg">
                    <Image src={venue_pic} alt="wedding_location" />
                </div>
            </div>
                ...
                <div className="top-8 text-center md:text-left pt-10">
                    ...
                    <div className="flex md:justify-start justify-center">
                        <a
                            ...
                            target="_blank"
                            className="px-5 py-2 transition-all text-lg font-semibold rounded-md bg-[#354834] outline-contrast-3 text-white outline-4 disabled:opacity-50 disabled:pointer-events-none cursor-pointer"
                            rel="noreferrer"
                        >
                            Map
                        </a>

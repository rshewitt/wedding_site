    ...
    return (
        <div className="fixed bottom-0 right-0 mr-3 mb-3">
            ...
            <Modal
                ...
                center
            >
                <h4 className="text-center font-head mb-6 font-bold text-2xl text-black">
                    Registry
                </h4>
                <div className="text-center text-black mb-6">
                    ...
                    four-slice toaster too, so if you really would like to get
                    us something, you can find some suggestion on our registry
                </div>
